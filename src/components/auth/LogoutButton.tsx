...
export default function LogoutButton() {
    ...
    return (
        <button
            ...
            disabled={isLoading}
            className="px-4 py-2 border border-red-300 text-red-700 rounded-md text-sm font-medium hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
        >
